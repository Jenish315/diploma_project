<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $query = "Select number from users where email = '$mail'";
        ...
        if (isset($_POST['password'])) {
            ...
            $update = "UPDATE `users` SET `password`='$password' WHERE email = '$mail'";
...
<html lang="en">
   ...
   <body class="main-layout">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-9">
                     <ul class="email text_align_right">
                        ...
                        <li class="d_none"><i class="fa fa-phone" aria-hidden="true"></i>+91 98682136</a></li>
      ...
      <form class="main_form">
                     ...
                     <input class="form-control"type="text" class="email-bt" placeholder="Email" name="email" value="<?php if(isset($_POST['email'])){echo $_POST['email'];}?>">
                    
                 
                    <input class="form-control" type="text" class="email-bt" placeholder="Mobile Number" name="number" value ="<?php if(isset($_POST['email'])){echo $_POST['number'];}?>">
                             
                     <?php
                     if ($dataFound == TRUE) {
                      
                        echo '<input type="password" class="form-control" placeholder="New Password" name="password">';
                     }
                     ?>
                     <button type="submit" class="send">Submit</button></div>
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="reader">
                        <h3>Contact Us</h3>
                        <p> Hello@gmail.com<br>Demo@gmail.com</p>                     </div>
                  </div>
               </div>
            </div>
